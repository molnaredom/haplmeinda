...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."AUTH_GROUP" 
   (	"ID" NUMBER(11,0) GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE , 
	"NAME" NVARCHAR2(150)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
--------------------------------------------------------
 ...
 LOB ("SESSION_DATA") STORE AS BASICFILE (
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) ;
--------------------------------------------------------
--  DDL for Table HAPLMELINDA_OLDAL_KEP
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."HAPLMELINDA_OLDAL_KEP" 
   (	"ID" NUMBER(11,0) GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE , 
	"SORSZAM" NUMBER(11,0), 
	"CIM" NVARCHAR2(200), 
	"BELSO_MERET" NVARCHAR2(200), 
	"KULSO_MERET" NVARCHAR2(200), 
	"AR" NUMBER(11,0), 
	"LEIRAS" NVARCHAR2(500), 
	"ELADVA" NUMBER(1,0), 
	"FELTOLTOTT_KEP" NVARCHAR2(100), 
	"TECHNIKA_ID" NUMBER(11,0), 
	"TEMA_ID" NUMBER(11,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table HAPLMELINDA_OLDAL_KOSAR
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."HAPLMELINDA_OLDAL_KOSAR" 
   (	"ID" NUMBER(11,0) GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE , 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table HAPLMELINDA_OLDAL_KOSAR_KEPEK
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."HAPLMELINDA_OLDAL_KOSAR_KEPEK" 
   (	"ID" NUMBER(11,0) GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE , 
	"KOSAR_ID" NUMBER(11,0), 
	"KEP_ID" NUMBER(11,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table HAPLMELINDA_OLDAL_PROFILE
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."HAPLMELINDA_OLDAL_PROFILE" 
   (	"ID" NUMBER(11,0) GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE , 
	"TELJES_NEV" NVARCHAR2(200), 
	"TELEFON" NVARCHAR2(15), 
	"SZALLITASI_HELY" NVARCHAR2(300), 
	"USER_ID" NUMBER(11,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table HAPLMELINDA_OLDAL_RENDELES
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."HAPLMELINDA_OLDAL_RENDELES" 
   (	"ID" NUMBER(11,0) GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE , 
	"KOSAR_ID" NUMBER(11,0), 
	"TOTAL_PRICE" NUMBER(11,0) DEFAULT NULL
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table HAPLMELINDA_OLDAL_TECHNIKA
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."HAPLMELINDA_OLDAL_TECHNIKA" 
   (	"ID" NUMBER(11,0) GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE , 
	"NEV" NVARCHAR2(200)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table HAPLMELINDA_OLDAL_TEMA
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."HAPLMELINDA_OLDAL_TEMA" 
   (	"ID" NUMBER(11,0) GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE , 
	"NEV" NVARCHAR2(200)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
...
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values (25,'Can add kep',7,'add_kep');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values (26,'Can change kep',7,'change_kep');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values (27,'Can delete kep',7,'delete_kep');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values (28,'Can view kep',7,'view_kep');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values (29,'Can add kosar',8,'add_kosar');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values (30,'Can change kosar',8,'change_kosar');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values (31,'Can delete kosar',8,'delete_kosar');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values (32,'Can view kosar',8,'view_kosar');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values (33,'Can add profile',9,'add_profile');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values (34,'Can change profile',9,'change_profile');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values (35,'Can delete profile',9,'delete_profile');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values (36,'Can view profile',9,'view_profile');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values (37,'Can add technika',10,'add_technika');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values (38,'Can change technika',10,'change_technika');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values (39,'Can delete technika',10,'delete_technika');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values (40,'Can view technika',10,'view_technika');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values (41,'Can add tema',11,'add_tema');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values (42,'Can change tema',11,'change_tema');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values (43,'Can delete tema',11,'delete_tema');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values (44,'Can view tema',11,'view_tema');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values (45,'Can add rendeles',12,'add_rendeles');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values (46,'Can change rendeles',12,'change_rendeles');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values (47,'Can delete rendeles',12,'delete_rendeles');
Insert into SYSTEM.AUTH_PERMISSION (ID,NAME,CONTENT_TYPE_ID,CODENAME) values (48,'Can view rendeles',12,'view_rendeles');
REM INSERTING into SYSTEM.AUTH_USER
SET DEFINE OFF;
Insert into SYSTEM.AUTH_USER (ID,PASSWORD,LAST_LOGIN,IS_SUPERUSER,USERNAME,FIRST_NAME,LAST_NAME,EMAIL,IS_STAFF,IS_ACTIVE,DATE_JOINED) values (1,'pbkdf2_sha256$150000$JHmDDwt52x9m$fzVTrcGtVKJXynv+hMo+vQYvAo1ui6cY1DZUJc2WqtU=',to_timestamp('05-MAY-23 10.29.03.463180000 AM','DD-MON-RR HH.MI.SSXFF AM'),0,'adam1',null,null,null,0,1,to_timestamp('05-MAY-23 10.29.03.194711000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.AUTH_USER (ID,PASSWORD,LAST_LOGIN,IS_SUPERUSER,USERNAME,FIRST_NAME,LAST_NAME,EMAIL,IS_STAFF,IS_ACTIVE,DATE_JOINED) values (2,'pbkdf2_sha256$150000$UZh3PrR67urh$P8vRtTkB/2uLDw5cERiy1OyPK1i1c1YtwcRUQQPD4Uw=',to_timestamp('05-MAY-23 10.53.17.063198000 AM','DD-MON-RR HH.MI.SSXFF AM'),0,'adam3',null,null,null,0,1,to_timestamp('05-MAY-23 10.53.16.881734000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.AUTH_USER (ID,PASSWORD,LAST_LOGIN,IS_SUPERUSER,USERNAME,FIRST_NAME,LAST_NAME,EMAIL,IS_STAFF,IS_ACTIVE,DATE_JOINED) values (3,'pbkdf2_sha256$150000$OPouH0zWDYXG$ObtEOEPhDROMs3ai7ZBW8/QtRNG5+kT/SvvtaOOzNFs=',to_timestamp('07-MAY-23 09.26.37.682798000 AM','DD-MON-RR HH.MI.SSXFF AM'),1,'admin',null,null,'a@a.com',1,1,to_timestamp('05-MAY-23 10.55.42.066847000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.AUTH_USER (ID,PASSWORD,LAST_LOGIN,IS_SUPERUSER,USERNAME,FIRST_NAME,LAST_NAME,EMAIL,IS_STAFF,IS_ACTIVE,DATE_JOINED) values (21,'pbkdf2_sha256$150000$eRCe6oPMMvCu$UTUhUORpIKIezqSYAyfAE4n7CMZKJyIYwYsZyyVbvSk=',to_timestamp('06-MAY-23 07.27.25.323387000 AM','DD-MON-RR HH.MI.SSXFF AM'),0,'ddd',null,null,null,0,1,to_timestamp('06-MAY-23 07.27.25.057993000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.AUTH_USER (ID,PASSWORD,LAST_LOGIN,IS_SUPERUSER,USERNAME,FIRST_NAME,LAST_NAME,EMAIL,IS_STAFF,IS_ACTIVE,DATE_JOINED) values (41,'pbkdf2_sha256$150000$W0ZstaoreOlk$dk9g9Hy9fYDTY2uR3DAqfr8KTi1cSzrdsD1X5vYIAiM=',to_timestamp('07-MAY-23 09.14.05.147140000 AM','DD-MON-RR HH.MI.SSXFF AM'),0,'eniko',null,null,null,0,1,to_timestamp('07-MAY-23 09.14.04.942230000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.AUTH_USER (ID,PASSWORD,LAST_LOGIN,IS_SUPERUSER,USERNAME,FIRST_NAME,LAST_NAME,EMAIL,IS_STAFF,IS_ACTIVE,DATE_JOINED) values (42,'pbkdf2_sha256$150000$6KBLftB40XDe$/yI2zXa3csqnB/lNVRixrFs0C2eOgGGNzqhmRCXODnA=',to_timestamp('07-MAY-23 09.25.07.470628000 AM','DD-MON-RR HH.MI.SSXFF AM'),0,'karoly',null,null,null,0,1,to_timestamp('07-MAY-23 09.25.07.283826000 AM','DD-MON-RR HH.MI.SSXFF AM'));
...
SET DEFINE OFF;
Insert into SYSTEM.DJANGO_ADMIN_LOG (ID,ACTION_TIME,OBJECT_REPR,ACTION_FLAG,CONTENT_TYPE_ID,USER_ID) values (1,to_timestamp('06-MAY-23 06.08.31.461868000 AM','DD-MON-RR HH.MI.SSXFF AM'),'kKosar object (3)',3,12,3);
Insert into SYSTEM.DJANGO_ADMIN_LOG (ID,ACTION_TIME,OBJECT_REPR,ACTION_FLAG,CONTENT_TYPE_ID,USER_ID) values (2,to_timestamp('06-MAY-23 06.12.42.485415000 AM','DD-MON-RR HH.MI.SSXFF AM'),'kKosar object (3)',3,12,3);
Insert into SYSTEM.DJANGO_ADMIN_LOG (ID,ACTION_TIME,OBJECT_REPR,ACTION_FLAG,CONTENT_TYPE_ID,USER_ID) values (3,to_timestamp('06-MAY-23 06.12.42.491228000 AM','DD-MON-RR HH.MI.SSXFF AM'),'kKosar object (3)',3,12,3);
Insert into SYSTEM.DJANGO_ADMIN_LOG (ID,ACTION_TIME,OBJECT_REPR,ACTION_FLAG,CONTENT_TYPE_ID,USER_ID) values (4,to_timestamp('06-MAY-23 06.12.42.496086000 AM','DD-MON-RR HH.MI.SSXFF AM'),'kKosar object (3)',3,12,3);
Insert into SYSTEM.DJANGO_ADMIN_LOG (ID,ACTION_TIME,OBJECT_REPR,ACTION_FLAG,CONTENT_TYPE_ID,USER_ID) values (5,to_timestamp('06-MAY-23 06.12.42.500769000 AM','DD-MON-RR HH.MI.SSXFF AM'),'kKosar object (3)',3,12,3);
Insert into SYSTEM.DJANGO_ADMIN_LOG (ID,ACTION_TIME,OBJECT_REPR,ACTION_FLAG,CONTENT_TYPE_ID,USER_ID) values (6,to_timestamp('06-MAY-23 06.12.42.504778000 AM','DD-MON-RR HH.MI.SSXFF AM'),'kKosar object (3)',3,12,3);
Insert into SYSTEM.DJANGO_ADMIN_LOG (ID,ACTION_TIME,OBJECT_REPR,ACTION_FLAG,CONTENT_TYPE_ID,USER_ID) values (7,to_timestamp('06-MAY-23 06.21.31.012317000 AM','DD-MON-RR HH.MI.SSXFF AM'),'kKosar object (3)',3,12,3);
Insert into SYSTEM.DJANGO_ADMIN_LOG (ID,ACTION_TIME,OBJECT_REPR,ACTION_FLAG,CONTENT_TYPE_ID,USER_ID) values (8,to_timestamp('06-MAY-23 06.21.31.017487000 AM','DD-MON-RR HH.MI.SSXFF AM'),'kKosar object (3)',3,12,3);
Insert into SYSTEM.DJANGO_ADMIN_LOG (ID,ACTION_TIME,OBJECT_REPR,ACTION_FLAG,CONTENT_TYPE_ID,USER_ID) values (9,to_timestamp('06-MAY-23 06.21.31.021348000 AM','DD-MON-RR HH.MI.SSXFF AM'),'kKosar object (3)',3,12,3);
Insert into SYSTEM.DJANGO_ADMIN_LOG (ID,ACTION_TIME,OBJECT_REPR,ACTION_FLAG,CONTENT_TYPE_ID,USER_ID) values (10,to_timestamp('06-MAY-23 07.31.46.132926000 AM','DD-MON-RR HH.MI.SSXFF AM'),'kKosar object (21)',3,12,3);
Insert into SYSTEM.DJANGO_ADMIN_LOG (ID,ACTION_TIME,OBJECT_REPR,ACTION_FLAG,CONTENT_TYPE_ID,USER_ID) values (21,to_timestamp('07-MAY-23 09.11.06.601841000 AM','DD-MON-RR HH.MI.SSXFF AM'),'adam1',3,4,3);
Insert into SYSTEM.DJANGO_ADMIN_LOG (ID,ACTION_TIME,OBJECT_REPR,ACTION_FLAG,CONTENT_TYPE_ID,USER_ID) values (22,to_timestamp('07-MAY-23 09.11.06.626736000 AM','DD-MON-RR HH.MI.SSXFF AM'),'adam3',3,4,3);
Insert into SYSTEM.DJANGO_ADMIN_LOG (ID,ACTION_TIME,OBJECT_REPR,ACTION_FLAG,CONTENT_TYPE_ID,USER_ID) values (23,to_timestamp('07-MAY-23 09.11.06.631755000 AM','DD-MON-RR HH.MI.SSXFF AM'),'ddd',3,4,3);
Insert into SYSTEM.DJANGO_ADMIN_LOG (ID,ACTION_TIME,OBJECT_REPR,ACTION_FLAG,CONTENT_TYPE_ID,USER_ID) values (24,to_timestamp('07-MAY-23 09.11.28.071833000 AM','DD-MON-RR HH.MI.SSXFF AM'),'kKosar object (3)',3,12,3);
Insert into SYSTEM.DJANGO_ADMIN_LOG (ID,ACTION_TIME,OBJECT_REPR,ACTION_FLAG,CONTENT_TYPE_ID,USER_ID) values (25,to_timestamp('07-MAY-23 09.11.28.077596000 AM','DD-MON-RR HH.MI.SSXFF AM'),'kKosar object (3)',3,12,3);
Insert into SYSTEM.DJANGO_ADMIN_LOG (ID,ACTION_TIME,OBJECT_REPR,ACTION_FLAG,CONTENT_TYPE_ID,USER_ID) values (26,to_timestamp('07-MAY-23 09.11.28.082181000 AM','DD-MON-RR HH.MI.SSXFF AM'),'kKosar object (3)',3,12,3);
Insert into SYSTEM.DJANGO_ADMIN_LOG (ID,ACTION_TIME,OBJECT_REPR,ACTION_FLAG,CONTENT_TYPE_ID,USER_ID) values (27,to_timestamp('07-MAY-23 09.11.28.086522000 AM','DD-MON-RR HH.MI.SSXFF AM'),'kKosar object (21)',3,12,3);
Insert into SYSTEM.DJANGO_ADMIN_LOG (ID,ACTION_TIME,OBJECT_REPR,ACTION_FLAG,CONTENT_TYPE_ID,USER_ID) values (28,to_timestamp('07-MAY-23 09.11.28.092402000 AM','DD-MON-RR HH.MI.SSXFF AM'),'kKosar object (21)',3,12,3);
Insert into SYSTEM.DJANGO_ADMIN_LOG (ID,ACTION_TIME,OBJECT_REPR,ACTION_FLAG,CONTENT_TYPE_ID,USER_ID) values (29,to_timestamp('07-MAY-23 09.11.57.566654000 AM','DD-MON-RR HH.MI.SSXFF AM'),'Ernő',2,9,3);
Insert into SYSTEM.DJANGO_ADMIN_LOG (ID,ACTION_TIME,OBJECT_REPR,ACTION_FLAG,CONTENT_TYPE_ID,USER_ID) values (30,to_timestamp('07-MAY-23 09.12.11.021354000 AM','DD-MON-RR HH.MI.SSXFF AM'),'Molnar Adam',2,9,3);
Insert into SYSTEM.DJANGO_ADMIN_LOG (ID,ACTION_TIME,OBJECT_REPR,ACTION_FLAG,CONTENT_TYPE_ID,USER_ID) values (31,to_timestamp('07-MAY-23 09.12.38.012834000 AM','DD-MON-RR HH.MI.SSXFF AM'),'Imre',2,9,3);
Insert into SYSTEM.DJANGO_ADMIN_LOG (ID,ACTION_TIME,OBJECT_REPR,ACTION_FLAG,CONTENT_TYPE_ID,USER_ID) values (32,to_timestamp('07-MAY-23 09.12.45.324034000 AM','DD-MON-RR HH.MI.SSXFF AM'),'Imre',2,9,3);
Insert into SYSTEM.DJANGO_ADMIN_LOG (ID,ACTION_TIME,OBJECT_REPR,ACTION_FLAG,CONTENT_TYPE_ID,USER_ID) values (33,to_timestamp('07-MAY-23 09.13.13.967856000 AM','DD-MON-RR HH.MI.SSXFF AM'),'Béla Endre',2,9,3);
...
Insert into SYSTEM.DJANGO_CONTENT_TYPE (ID,APP_LABEL,MODEL) values (7,'haplmelinda_oldal','kep');
Insert into SYSTEM.DJANGO_CONTENT_TYPE (ID,APP_LABEL,MODEL) values (8,'haplmelinda_oldal','kosar');
Insert into SYSTEM.DJANGO_CONTENT_TYPE (ID,APP_LABEL,MODEL) values (9,'haplmelinda_oldal','profile');
Insert into SYSTEM.DJANGO_CONTENT_TYPE (ID,APP_LABEL,MODEL) values (10,'haplmelinda_oldal','technika');
Insert into SYSTEM.DJANGO_CONTENT_TYPE (ID,APP_LABEL,MODEL) values (11,'haplmelinda_oldal','tema');
Insert into SYSTEM.DJANGO_CONTENT_TYPE (ID,APP_LABEL,MODEL) values (12,'haplmelinda_oldal','rendeles');
REM INSERTING into SYSTEM.DJANGO_MIGRATIONS
SET DEFINE OFF;
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values (1,'contenttypes','0001_initial',to_timestamp('05-MAY-23 10.25.58.578623000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values (2,'auth','0001_initial',to_timestamp('05-MAY-23 10.25.58.782634000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values (3,'admin','0001_initial',to_timestamp('05-MAY-23 10.25.59.136387000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values (4,'admin','0002_logentry_remove_auto_add',to_timestamp('05-MAY-23 10.25.59.256273000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values (5,'admin','0003_logentry_add_action_flag_choices',to_timestamp('05-MAY-23 10.25.59.305947000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values (6,'contenttypes','0002_remove_content_type_name',to_timestamp('05-MAY-23 10.25.59.545459000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values (7,'auth','0002_alter_permission_name_max_length',to_timestamp('05-MAY-23 10.25.59.600611000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values (8,'auth','0003_alter_user_email_max_length',to_timestamp('05-MAY-23 10.25.59.653440000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values (9,'auth','0004_alter_user_username_opts',to_timestamp('05-MAY-23 10.25.59.694279000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values (10,'auth','0005_alter_user_last_login_null',to_timestamp('05-MAY-23 10.25.59.744898000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values (11,'auth','0006_require_contenttypes_0002',to_timestamp('05-MAY-23 10.25.59.775988000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values (12,'auth','0007_alter_validators_add_error_messages',to_timestamp('05-MAY-23 10.25.59.816503000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values (13,'auth','0008_alter_user_username_max_length',to_timestamp('05-MAY-23 10.25.59.867712000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values (14,'auth','0009_alter_user_last_name_max_length',to_timestamp('05-MAY-23 10.25.59.916497000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values (15,'auth','0010_alter_group_name_max_length',to_timestamp('05-MAY-23 10.25.59.963863000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values (16,'auth','0011_update_proxy_permissions',to_timestamp('05-MAY-23 10.25.59.999940000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values (17,'haplmelinda_oldal','0001_initial',to_timestamp('05-MAY-23 10.26.00.292426000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values (18,'haplmelinda_oldal','0002_auto_20230505_0948',to_timestamp('05-MAY-23 10.26.03.719241000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values (19,'sessions','0001_initial',to_timestamp('05-MAY-23 10.26.03.775704000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values (20,'haplmelinda_oldal','0003_remove_rendeles_total_price',to_timestamp('05-MAY-23 10.32.51.582540000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values (21,'haplmelinda_oldal','0004_auto_20230505_1122',to_timestamp('05-MAY-23 11.22.41.761651000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values (22,'haplmelinda_oldal','0005_auto_20230505_1129',to_timestamp('05-MAY-23 11.29.34.393672000 AM','DD-MON-RR HH.MI.SSXFF AM'));
REM INSERTING into SYSTEM.DJANGO_SESSION
SET DEFINE OFF;
Insert into SYSTEM.DJANGO_SESSION (SESSION_KEY,EXPIRE_DATE) values ('7rodshvso5lkjegasksgl5o7wv57l6tt',to_timestamp('21-MAY-23 09.26.37.692373000 AM','DD-MON-RR HH.MI.SSXFF AM'));
REM INSERTING into SYSTEM.HAPLMELINDA_OLDAL_KEP
SET DEFINE OFF;
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (1,107,'Erdőben nappal és éjjel','39.0x29.0','42.9x22.8',30000,'leiras',0,'upload/107.jpg',1,3);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (2,74,'Indás nő','15.0x30.8','21.4x37.5',30000,'leiras',0,'upload/74.jpg',1,1);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (3,76,'Hableány','15.0x31.0','21.4x37.5',30000,'leiras',0,'upload/76.jpg',1,1);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (4,71,'Erdőben a nő','15.2x31.2','23.5x39.5',30000,'leiras',0,'upload/71.jpg',1,2);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (5,99,'Levelek között','24.1x24.1','27.8x27.8',30000,'leiras',0,'upload/99.jpg',1,1);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (6,91,'Cseresznyefa virág','8.1x25.0','18.4x35.3',30000,'leiras',0,'upload/91.jpg',4,6);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (7,90,'Kék pipacs','8.1x25.0','18.4x35.3',30000,'leiras',0,'upload/90.jpg',4,6);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (8,62,'Páva','18.4x23.5','26.9x31.9',30000,'leiras',0,'upload/62.jpg',4,8);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (9,104,'Szellőrózsa','18.1x24.3','25.4x31.2',30000,'leiras',0,'upload/104.jpg',4,6);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (10,96,'Indák királynője','11.1x20.1','19.8x28.8',30000,'leiras',0,'upload/96.jpg',4,1);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (11,100,'Fehér virágok (olaj vászon)','18.2x24.3','25.3x31.5',30000,'leiras',0,'upload/100.jpg',4,6);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (12,102,'Fehér pipacs','18.2x24.4','25.3x31.5',30000,'leiras',0,'upload/102.jpg',4,6);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (13,31,'Pipacs',' 16.1x16.1','24.6x24.6',30000,'leiras',0,'upload/31.jpg',2,3);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (14,101,'Tulipánfa','18.1x24.6','25.3x31.4',30000,'leiras',0,'upload/101.jpg',4,6);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (15,105,'Bordó tulipánok','18.1x24.6','25.3x31.4',30000,'leiras',0,'upload/105.jpg',4,6);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (18,95,'Tűz királynő','20.9x14.8','29.5x23.5',30000,'leiras',0,'upload/95.jpg',1,1);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (19,24,'Bimbós hölgy','15.1x12.1','27.4x21.4',30000,'leiras',0,'upload/24.jpg',2,2);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (20,7,'Balerina','20.1x15.3','29.5x24.5',30000,'leiras',0,'upload/7.jpg',2,1);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (21,2,'Dombos táj','20.1x15.0','26.9x21.737',30000,'leiras',0,'upload/2.jpg',2,3);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (22,37,'Dombos táj','4.2x10.8','13.1x17.9',30000,'leiras',0,'upload/37.jpg',2,3);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (23,40,'Magányos fa','6.3x9.2','12.1x15.1',30000,'leiras',0,'upload/40.jpg',2,3);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (24,79,'Egymáshoz érve (háttal)','24.0x11.6','34.3x17.9',30000,'leiras',0,'upload/79.jpg',4,5);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (25,11,'Fénybe néző','9.8x18.9','18.9x27.3',30000,'leiras',0,'upload/11.jpg',2,2);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (26,86,'Mandala 2','23.9x23.9','27.6x27.6',30000,'leiras',0,'upload/86.jpg',1,9);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (28,17,'Szerelem','23.0x17.1','32.4x26.5',30000,'leiras',0,'upload/17.jpg',2,5);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (29,82,'Ég és föld között','19.8x14','8x34.0x28.0',30000,'leiras',0,'upload/82.jpg',1,1);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (30,70,'Karcnő','29.2x19.3','34.7x24.7',30000,'leiras',0,'upload/70.jpg',4,1);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (32,1,'Erdőben','20.1x21.8','26.8x21.8',30000,'leiras',0,'upload/1.jpg',2,3);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (33,103,'Sárga liliom','14.3x18.0','31.0x25.1',30000,'leiras',0,'upload/103.jpg',4,6);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (34,110,'Őszi lány fakerettel','7.0x9.3','18.4x18.4',30000,'leiras',0,'upload/110.jpg',4,10);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (35,83,'Fa a domb előtt','15.3x9.9','22.4x17.0',30000,'leiras',0,'upload/83.jpg',1,3);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (36,61,'Liliom','24.0','24.0',30000,'leiras',0,'upload/61.jpg',1,6);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (37,23,'Őszi hölgy','14.2x11.2','20.2x17.3',30000,'leiras',0,'upload/23.jpg',2,2);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (38,5,'Imádkozó kereszt','9.9x5.1','21.1x21.1',30000,'leiras',0,'upload/5.jpg',2,10);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (39,12,'Nyári lány','9.8x7.9','21.4x19.4',30000,'leiras',0,'upload/12.jpg',2,2);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (40,10,'Őszi lány','9.8x7.9','21.4x19.4',30000,'leiras',0,'upload/10.jpg',2,2);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (41,15,'Esőben','9.8x7.9','21.4x19.4',30000,'leiras',0,'upload/15.jpg',2,1);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (42,63,'Keltai kereszt','18.6x8.1','22.8x12.8',30000,'leiras',0,'upload/63.jpg',4,4);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (43,64,'Tápiószentmártoni szkíta aranyszarvas','9.1x19.1','12.9x22.8',30000,'leiras',0,'upload/64.jpg',4,8);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (44,68,'Zöldhalompusztai szkíta aranyszarvas','9.1x19.1','12.9x22.8',30000,'leiras',0,'upload/68.jpg',4,8);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (46,30,'Folyó szélén','9.7x19.6','12.3x22.2',30000,'leiras',0,'upload/30.jpg',2,3);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (47,13,'Hosszú hajú lány','9.9x7.9','21.4x19.4',30000,'leiras',0,'upload/13.jpg',2,1);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (48,42,'Szőke hajú nő','4.0x9.0','9.6x14.7',30000,'leiras',0,'upload/42.jpg',2,2);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (49,9,'Szerelem','9.5x6.6','21.0x18.2',30000,'leiras',0,'upload/9.jpg',2,5);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (50,8,'Egymásba olvadva','9.5x6.6','21.0x18.2',30000,'leiras',0,'upload/8.jpg',2,5);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (51,21,'Táncoló lány','15.0x12.0','27.3x21.4',30000,'leiras',0,'upload/21.jpg',2,1);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (53,85,'Mandala 1','10.2x10.2','19.3x19.3',30000,'leiras',0,'upload/85.jpg',1,4);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (54,84,'Halak kövekkel','10.2x10.2','19.3x19.3',30000,'leiras',0,'upload/84.jpg',4,10);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (55,57,'Liliom hölgy','14.2x8.6','17.2x11.7',30000,'leiras',0,'upload/57.jpg',4,1);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (56,38,'Indák között','9.2x9.2','15.0x15.0',30000,'leiras',0,'upload/38.jpg',2,1);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (57,58,'Mákvirág 2.','8.8x7.0','11.2x9.2',30000,'leiras',0,'upload/58.jpg',4,1);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (58,45,'Lovas kép 1.','4.4x9.5','10.4x15.4',30007,'leiras',0,'upload/45.jpg',2,8);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (59,506,'Régi Magyarország','9.3x13.9','12.9x16.9',30000,'leiras',0,'upload/506.jpg',3,10);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (60,41,'A nagy fa','5.8x8.9','9.8x13.0',30000,'leiras',0,'upload/41.jpg',2,3);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (61,34,'Erdőben','...','...',30000,'leiras',0,'upload/34.jpg',2,3);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (62,36,'Fa a domboldalon','...','...',30000,'leiras',0,'upload/36.jpg',2,3);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (63,22,'Laura','...','...',30000,'leiras',0,'upload/22.jpg',2,2);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (64,19,'Hullámlovas lány','...','...',30000,'leiras',0,'upload/19.jpg',2,1);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (65,39,'Félre néző lány','...','...',30000,'leiras',0,'upload/39.jpg',2,1);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (67,33,'Orhidea','...','...',30000,'leiras',0,'upload/33.jpg',2,6);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (68,47,'Mini erdő részlet','...','...',30000,'leiras',0,'upload/47.jpg',2,3);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (69,43,'Lepkeszárnyon','...','...',30000,'leiras',0,'upload/43.jpg',2,2);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (70,14,'Édenkert','...','...',30000,'leiras',0,'upload/14.jpg',2,2);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (71,6,'Álomba ringatva','...','...',30000,'leiras',0,'upload/6.jpg',2,5);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (72,4,'Három lány','...','...',30000,'leiras',0,'upload/4.jpg',2,2);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (73,20,'Szerelem a tóban','...','...',30000,'leiras',0,'upload/20.jpg',2,5);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (74,29,'Tengeri város','...','...',30000,'leiras',0,'upload/29.jpg',2,3);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (75,28,'Tengerben úszó ember','...','...',30000,'leiras',0,'upload/28.jpg',2,10);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (76,25,'Szent család szamárháton','...','...',30000,'leiras',0,'upload/25.jpg',2,10);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (78,48,'Nyári lány 2','...','...',30000,'leiras',0,'upload/48.jpg',2,2);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (79,49,'Kettes virág','...','...',30000,'leiras',0,'upload/49.jpg',2,6);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (80,32,'Tűz','...','...',30000,'leiras',0,'upload/32.jpg',2,3);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (81,50,'Hármas virág','...','...',30000,'leiras',0,'upload/50.jpg',2,6);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (82,51,'Rózsaszín virág','...','...',30000,'leiras',0,'upload/51.jpg',2,6);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (83,49,'??Őszi lány 3.','...','...',30000,'leiras',0,'upload/49.jpg',2,10);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (84,50,'Lepke','...','...',30000,'leiras',0,'upload/50.jpg',2,8);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (85,200,'Boldog maci 1.','...','...',30000,'leiras',0,'upload/200.jpg',2,10);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (86,201,'Boldog maci 2.','...','...',30000,'leiras',0,'upload/201.jpg',2,7);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (87,202,'Szerelmes maci pár','...','...',30000,'leiras',0,'upload/202.jpg',2,7);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (88,203,'Kis állatok az erdőben','...','...',30000,'leiras',0,'upload/203.jpg',2,7);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (89,204,'Három jó barát','...','...',30000,'leiras',0,'upload/204.jpg',2,7);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (90,205,'Pingvinek','...','...',30000,'leiras',0,'upload/205.jpg',2,7);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (92,59,'Buddha','...','...',30000,'leiras',0,'upload/59.jpg',4,4);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (93,60,'Táncoló nő','...','...',30000,'leiras',0,'upload/60.jpg',4,1);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (94,56,'Mini kereszt','...','...',30000,'leiras',0,'upload/56.jpg',4,10);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (95,66,'Turul madár','...','...',30000,'leiras',0,'upload/66.jpg',4,8);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (97,300,'Helikopter 1','...','...',30000,'leiras',0,'upload/300.jpg',4,10);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (98,301,'Helikopter 2','...','...',30000,'leiras',0,'upload/301.jpg',4,10);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (99,302,'Helikopter 3','...','...',30000,'leiras',0,'upload/302.jpg',4,10);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (100,400,'Ponty','...','...',30000,'leiras',0,'upload/400.jpg',4,8);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (102,402,'Harcsa','...','...',30000,'leiras',0,'upload/402.jpg',4,8);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (103,403,'Fogas süllő','...','...',30000,'leiras',0,'upload/403.jpg',4,8);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (104,404,'Ponty 2','...','...',30000,'leiras',0,'upload/404.jpg',4,8);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (105,500,'Éva','...','...',30000,'leiras',0,'upload/500.jpg',3,1);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (106,501,'Szerelmes pár 1','...','...',30000,'leiras',0,'upload/501.jpg',3,5);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (107,502,'Vaddisznó','...','...',30000,'leiras',0,'upload/502.jpg',3,8);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (109,505,'Mákvirág','...','...',30000,'leiras',0,'upload/505.jpg',3,1);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (110,504,'Távolba néző','...','...',30000,'leiras',0,'upload/504.jpg',3,1);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (111,78,'Szerelmes pár','...','...',30000,'leiras',0,'upload/78.jpg',1,1);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (112,503,'Nő és férfi','...','...',30000,'leiras',0,'upload/503.jpg',3,10);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (113,69,'Buddha 2','...','...',30000,'leiras',0,'upload/69.jpg',1,10);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (114,87,'Mandala 3','...','...',30000,'leiras',0,'upload/87.jpg',1,4);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (117,105,'Erdő részlet','...','...',30000,'leiras',0,'upload/105.jpg',1,3);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (118,105,'Két ágú fa','...','...',30000,'leiras',0,'upload/105.jpg',1,3);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (119,72,'Bokor hölgy','...','...',30000,'leiras',0,'upload/72.jpg',1,1);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (120,73,'Fa hölgy','...','...',30000,'leiras',0,'upload/73.jpg',1,1);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (121,77,'Inda hölgy','...','...',30000,'leiras',0,'upload/77.jpg',1,1);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (122,75,'Szerelem az erdőben','...','...',30000,'leiras',0,'upload/75.jpg',1,5);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (123,81,'Csónak','...','...',30000,'leiras',0,'upload/81.jpg',4,3);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (132,80,'Tájkép','...','...',30000,'leiras',0,'upload/80.jpg',4,3);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (133,94,'Madarak között','...','...',30000,'leiras',0,'upload/94.jpg',4,2);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (134,92,'Bokor nő','...','...',30000,'leiras',0,'upload/92.jpg',4,1);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (135,93,'Hullámok között','...','...',30000,'leiras',0,'upload/93.jpg',4,1);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (137,35,'Szerelem az erdőben 2','...','...',30000,'leiras',0,'upload/35.jpg',2,3);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (138,46,'Lovas kép 2','...','...',30000,'leiras',0,'upload/46.jpg',2,8);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (139,3,'Erdei út',' ',' ',30000,'leiras',0,'upload/3.jpg',2,3);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (140,65,'Aranyszarvas',' ',' ',30000,'leiras',1,'upload/65.jpg',4,8);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (141,18,'Jézus',' ',' ',30000,'leiras',0,'upload/18.jpg',2,4);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (142,16,'Ugró szarvas',' ',' ',30000,'leiras',0,'upload/16.jpg',2,4);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (143,111,'Mária',' ',' ',30000,'leiras',0,'upload/111.jpg',2,4);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (144,112,'Nap és Hold',' ',' ',30000,'leiras',1,'upload/112.jpg',4,4);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (145,113,'Jézus születése',' ',' ',30000,'leiras',0,'upload/113.jpg',4,4);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (146,114,'Élet fája',' ',' ',30000,'leiras',0,'upload/114.jpg',1,3);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (147,115,'Szív mandala',' ',' ',30000,'leiras',0,'upload/115.jpg',1,9);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KEP (ID,SORSZAM,CIM,BELSO_MERET,KULSO_MERET,AR,LEIRAS,ELADVA,FELTOLTOTT_KEP,TECHNIKA_ID,TEMA_ID) values (148,88,'Mandala 4',' ',' ',30000,'leiras',0,'upload/88.jpg',1,3);
REM INSERTING into SYSTEM.HAPLMELINDA_OLDAL_KOSAR
SET DEFINE OFF;
Insert into SYSTEM.HAPLMELINDA_OLDAL_KOSAR (ID,PROFILE_ID) values (1,1);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KOSAR (ID,PROFILE_ID) values (2,2);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KOSAR (ID,PROFILE_ID) values (3,3);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KOSAR (ID,PROFILE_ID) values (21,21);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KOSAR (ID,PROFILE_ID) values (41,41);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KOSAR (ID,PROFILE_ID) values (42,42);
REM INSERTING into SYSTEM.HAPLMELINDA_OLDAL_KOSAR_KEPEK
SET DEFINE OFF;
Insert into SYSTEM.HAPLMELINDA_OLDAL_KOSAR_KEPEK (ID,KOSAR_ID,KEP_ID) values (1,1,64);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KOSAR_KEPEK (ID,KOSAR_ID,KEP_ID) values (2,1,81);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KOSAR_KEPEK (ID,KOSAR_ID,KEP_ID) values (3,2,15);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KOSAR_KEPEK (ID,KOSAR_ID,KEP_ID) values (47,41,141);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KOSAR_KEPEK (ID,KOSAR_ID,KEP_ID) values (48,41,41);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KOSAR_KEPEK (ID,KOSAR_ID,KEP_ID) values (52,3,58);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KOSAR_KEPEK (ID,KOSAR_ID,KEP_ID) values (50,42,75);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KOSAR_KEPEK (ID,KOSAR_ID,KEP_ID) values (45,41,40);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KOSAR_KEPEK (ID,KOSAR_ID,KEP_ID) values (46,41,64);
Insert into SYSTEM.HAPLMELINDA_OLDAL_KOSAR_KEPEK (ID,KOSAR_ID,KEP_ID) values (51,42,103);
REM INSERTING into SYSTEM.HAPLMELINDA_OLDAL_PROFILE
SET DEFINE OFF;
Insert into SYSTEM.HAPLMELINDA_OLDAL_PROFILE (ID,TELJES_NEV,TELEFON,SZALLITASI_HELY,USER_ID) values (1,'Imre','06 70 12819221','Táborfalva',1);
Insert into SYSTEM.HAPLMELINDA_OLDAL_PROFILE (ID,TELJES_NEV,TELEFON,SZALLITASI_HELY,USER_ID) values (2,'Molnar Adam','0120120100000','Szeged',2);
Insert into SYSTEM.HAPLMELINDA_OLDAL_PROFILE (ID,TELJES_NEV,TELEFON,SZALLITASI_HELY,USER_ID) values (3,'Ernő','06501234567','Szolnok',3);
Insert into SYSTEM.HAPLMELINDA_OLDAL_PROFILE (ID,TELJES_NEV,TELEFON,SZALLITASI_HELY,USER_ID) values (21,'Béla Endre','06 32412312','Budapest',21);
Insert into SYSTEM.HAPLMELINDA_OLDAL_PROFILE (ID,TELJES_NEV,TELEFON,SZALLITASI_HELY,USER_ID) values (41,'Enikő','06 40 324234234','Veszprém',41);
Insert into SYSTEM.HAPLMELINDA_OLDAL_PROFILE (ID,TELJES_NEV,TELEFON,SZALLITASI_HELY,USER_ID) values (42,'Nagy Károly','06 45 453453','Jászkarajenő',42);
REM INSERTING into SYSTEM.HAPLMELINDA_OLDAL_RENDELES
SET DEFINE OFF;
Insert into SYSTEM.HAPLMELINDA_OLDAL_RENDELES (ID,KOSAR_ID,TOTAL_PRICE) values (82,41,120000);
REM INSERTING into SYSTEM.HAPLMELINDA_OLDAL_TECHNIKA
SET DEFINE OFF;
Insert into SYSTEM.HAPLMELINDA_OLDAL_TECHNIKA (ID,NEV) values (1,'fa');
Insert into SYSTEM.HAPLMELINDA_OLDAL_TECHNIKA (ID,NEV) values (2,'tűzzománc');
Insert into SYSTEM.HAPLMELINDA_OLDAL_TECHNIKA (ID,NEV) values (3,'üveg');
Insert into SYSTEM.HAPLMELINDA_OLDAL_TECHNIKA (ID,NEV) values (4,'Egyéb');
REM INSERTING into SYSTEM.HAPLMELINDA_OLDAL_TEMA
SET DEFINE OFF;
Insert into SYSTEM.HAPLMELINDA_OLDAL_TEMA (ID,NEV) values (1,'női alak');
Insert into SYSTEM.HAPLMELINDA_OLDAL_TEMA (ID,NEV) values (2,'női arc');
Insert into SYSTEM.HAPLMELINDA_OLDAL_TEMA (ID,NEV) values (3,'természet');
Insert into SYSTEM.HAPLMELINDA_OLDAL_TEMA (ID,NEV) values (4,'vallási téma');
Insert into SYSTEM.HAPLMELINDA_OLDAL_TEMA (ID,NEV) values (5,'szerelem');
Insert into SYSTEM.HAPLMELINDA_OLDAL_TEMA (ID,NEV) values (6,'virág');
Insert into SYSTEM.HAPLMELINDA_OLDAL_TEMA (ID,NEV) values (7,'mese figura');
Insert into SYSTEM.HAPLMELINDA_OLDAL_TEMA (ID,NEV) values (8,'állat');
Insert into SYSTEM.HAPLMELINDA_OLDAL_TEMA (ID,NEV) values (9,'mandala');
Insert into SYSTEM.HAPLMELINDA_OLDAL_TEMA (ID,NEV) values (10,'Egyéb');
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index HAPLMELIN_KOSAR_ID__ECC0F808_U
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."HAPLMELIN_KOSAR_ID__ECC0F808_U" ON "SYSTEM"."HAPLMELINDA_OLDAL_KOSAR_KEPEK" ("KOSAR_ID", "KEP_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Index HAPLMELIND_KOSAR_ID_7794CD93
--------------------------------------------------------

  CREATE INDEX "SYSTEM"."HAPLMELIND_KOSAR_ID_7794CD93" ON "SYSTEM"."HAPLMELINDA_OLDAL_KOSAR_KEPEK" ("KOSAR_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Index HAPLMELIND_USER_ID_0123B54D
--------------------------------------------------------

  CREATE INDEX "SYSTEM"."HAPLMELIND_USER_ID_0123B54D" ON "SYSTEM"."HAPLMELINDA_OLDAL_KOSAR" ("PROFILE_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index HAPLMELIND_TECHNIKA_I_049A922F
--------------------------------------------------------

  CREATE INDEX "SYSTEM"."HAPLMELIND_TECHNIKA_I_049A922F" ON "SYSTEM"."HAPLMELINDA_OLDAL_KEP" ("TECHNIKA_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Index HAPLMELIND_TEMA_ID_06B7A2C1
--------------------------------------------------------

  CREATE INDEX "SYSTEM"."HAPLMELIND_TEMA_ID_06B7A2C1" ON "SYSTEM"."HAPLMELINDA_OLDAL_KEP" ("TEMA_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index HAPLMELIND_KOSAR_ID_40066412
--------------------------------------------------------

  CREATE INDEX "SYSTEM"."HAPLMELIND_KOSAR_ID_40066412" ON "SYSTEM"."HAPLMELINDA_OLDAL_RENDELES" ("KOSAR_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index HAPLMELIND_KEP_ID_000DC878
--------------------------------------------------------

  CREATE INDEX "SYSTEM"."HAPLMELIND_KEP_ID_000DC878" ON "SYSTEM"."HAPLMELINDA_OLDAL_KOSAR_KEPEK" ("KEP_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
--  DDL for Trigger KOSARTORLES
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."KOSARTORLES" 
BEFORE DELETE ON haplmelinda_oldal_profile
FOR EACH ROW
BEGIN
    DELETE FROM haplmelinda_oldal_kosar WHERE id = haplmelinda_oldal_profile.id;
    INSERT INTO haplmelinda_oldal_kosar VALUES (haplmelinda_oldal_profile.id, haplmelinda_oldal_profile.id);
END;
/
ALTER TRIGGER "SYSTEM"."KOSARTORLES" ENABLE;
--------------------------------------------------------
--  DDL for Trigger RENDELES_MEGSZUNES
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."RENDELES_MEGSZUNES" 
...
BEGIN
  ...
  END;
/
ALTER TRIGGER "SYSTEM"."RENDELES_MEGSZUNES" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Trigger UJ_KOSAR_TR
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."UJ_KOSAR_TR" 
...
END;
/
ALTER TRIGGER "SYSTEM"."UJ_KOSAR_TR" ENABLE;
--------------------------------------------------------
...
/
  ...
  GRANT SELECT ON "SYSTEM"."DEF$_AQCALL" TO "SYS";
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table HAPLMELINDA_OLDAL_PROFILE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_PROFILE" ADD UNIQUE ("USER_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_PROFILE" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_PROFILE" MODIFY ("USER_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_PROFILE" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table HAPLMELINDA_OLDAL_RENDELES
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_RENDELES" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_RENDELES" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table HAPLMELINDA_OLDAL_KEP
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_KEP" MODIFY ("TEMA_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_KEP" MODIFY ("TECHNIKA_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_KEP" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_KEP" ADD CHECK ("ELADVA" IN (0,1)) ENABLE;
  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_KEP" MODIFY ("ELADVA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_KEP" MODIFY ("AR" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_KEP" MODIFY ("SORSZAM" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_KEP" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table HAPLMELINDA_OLDAL_KOSAR
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_KOSAR" MODIFY ("PROFILE_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_KOSAR" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_KOSAR" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSAUX"  ENABLE;
--------------------------------------------------------
--  Constraints for Table HAPLMELINDA_OLDAL_TEMA
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_TEMA" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_TEMA" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table HAPLMELINDA_OLDAL_KOSAR_KEPEK
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_KOSAR_KEPEK" ADD CONSTRAINT "HAPLMELIN_KOSAR_ID__ECC0F808_U" UNIQUE ("KOSAR_ID", "KEP_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_KOSAR_KEPEK" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_KOSAR_KEPEK" MODIFY ("KEP_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_KOSAR_KEPEK" MODIFY ("KOSAR_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_KOSAR_KEPEK" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table HAPLMELINDA_OLDAL_TECHNIKA
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_TECHNIKA" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_TECHNIKA" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."DJANGO_ADMIN_LOG" ADD CONSTRAINT "DJANGO_AD_USER_ID_C564EBA6_F" FOREIGN KEY ("USER_ID")
	  REFERENCES "SYSTEM"."AUTH_USER" ("ID") DEFERRABLE INITIALLY DEFERRED ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table HAPLMELINDA_OLDAL_KEP
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_KEP" ADD CONSTRAINT "HAPLMELIN_TECHNIKA__049A922F_F" FOREIGN KEY ("TECHNIKA_ID")
	  REFERENCES "SYSTEM"."HAPLMELINDA_OLDAL_TECHNIKA" ("ID") DEFERRABLE INITIALLY DEFERRED ENABLE;
  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_KEP" ADD CONSTRAINT "HAPLMELIN_TEMA_ID_06B7A2C1_F" FOREIGN KEY ("TEMA_ID")
	  REFERENCES "SYSTEM"."HAPLMELINDA_OLDAL_TEMA" ("ID") DEFERRABLE INITIALLY DEFERRED ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table HAPLMELINDA_OLDAL_KOSAR
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_KOSAR" ADD CONSTRAINT "HAPLMELIN_PROFILE_I_CAE66EA1_F" FOREIGN KEY ("PROFILE_ID")
	  REFERENCES "SYSTEM"."HAPLMELINDA_OLDAL_PROFILE" ("ID") DEFERRABLE INITIALLY DEFERRED ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table HAPLMELINDA_OLDAL_KOSAR_KEPEK
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_KOSAR_KEPEK" ADD CONSTRAINT "HAPLMELIN_KEP_ID_000DC878_F" FOREIGN KEY ("KEP_ID")
	  REFERENCES "SYSTEM"."HAPLMELINDA_OLDAL_KEP" ("ID") DEFERRABLE INITIALLY DEFERRED ENABLE;
  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_KOSAR_KEPEK" ADD CONSTRAINT "HAPLMELIN_KOSAR_ID_7794CD93_F" FOREIGN KEY ("KOSAR_ID")
	  REFERENCES "SYSTEM"."HAPLMELINDA_OLDAL_KOSAR" ("ID") DEFERRABLE INITIALLY DEFERRED ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table HAPLMELINDA_OLDAL_PROFILE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_PROFILE" ADD CONSTRAINT "HAPLMELIN_USER_ID_282D3027_F" FOREIGN KEY ("USER_ID")
	  REFERENCES "SYSTEM"."AUTH_USER" ("ID") DEFERRABLE INITIALLY DEFERRED ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table HAPLMELINDA_OLDAL_RENDELES
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."HAPLMELINDA_OLDAL_RENDELES" ADD CONSTRAINT "HAPLMELIN_KOSAR_ID_40066412_F" FOREIGN KEY ("KOSAR_ID")
	  REFERENCES "SYSTEM"."HAPLMELINDA_OLDAL_KOSAR" ("ID") DEFERRABLE INITIALLY DEFERRED ENABLE;
--------------------------------------------------------
